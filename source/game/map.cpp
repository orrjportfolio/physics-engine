...
namespace Map {
	...
	static auto
		...
		waterMaterial = Material{.kind = Material::KIND_LIT_UNTEXED, .colour = glm::vec3(1.0f, 1.0f, 1.0f)},
		sandMaterial = Material{.kind = Material::KIND_LIT, .tex = &sandTex, .colour = glm::vec3(1.0f)},
		rockMaterial = Material{.kind = Material::KIND_LIT_UNTEXED, .colour = glm::vec3(1.0f, 1.0f, 1.0f)},
	...
	Object objects[] = {
		...
		Object{
			.pos = glm::vec3(169.06520080566406, 1.3107022047042847, 83.20133972167969),
			.halfSize = glm::vec3(4.959654331207275, 0.0, 3.200345993041992),
		...
		Object{
			...
			.rot = glm::vec3(0.0, 0.0, -0.0),
			.material = &waterMaterial, .physMaterial = waterPhysMaterial
		},
		Object{
		...
		Object{
			...
			.halfSize = glm::vec3(130.78656005859375, 0.0, 188.93142700195312),
			.rot = glm::vec3(0.0, 0.0, -0.0),
			.material = &waterMaterial, .physMaterial = waterPhysMaterial
		}
	};
